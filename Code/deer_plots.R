...
deer_wmfplot(wsyn::wt(cleandat(climindex$WinterPDO[1,],clev=5,times=minyear:maxyear)$cdat,times=minyear:maxyear),colorbar=T,xlab="",ylab="",power=T)
mtext("A)",adj=0.05,line=-1.2,side=3,font=2)
deer_wmfplot(wsyn::wt(cleandat(climindex$SummerPDO[1,],clev=5,times=minyear:maxyear)$cdat,times=minyear:maxyear),colorbar=T,xlab="",ylab="",power=T)
mtext("B)",adj=0.05,line=-1.2,side=3,font=2)
deer_wmfplot(wsyn::wt(cleandat(climindex$WinterNAO[1,],clev=5,times=minyear:maxyear)$cdat,times=minyear:maxyear),colorbar=T,xlab="",ylab="Timescale",power=T)
mtext("C)",adj=0.05,line=-1.2,side=3,font=2)
deer_wmfplot(wsyn::wt(cleandat(climindex$SummerNAO[1,],clev=5,times=minyear:maxyear)$cdat,times=minyear:maxyear),colorbar=T,ylab="",xlab="",power=T)
mtext("D)",adj=0.05,font=2,line=-1.2,side=3)
deer_wmfplot(wsyn::wt(cleandat(climindex$WinterMEI[1,],clev=5,times=minyear:maxyear)$cdat,times=minyear:maxyear),colorbar=T,xlab="Year",ylab="",power=T)
mtext("E)",adj=0.05,line=-1.2,side=3,font=2)
deer_wmfplot(wsyn::wt(cleandat(climindex$SummerMEI[1,],clev=5,times=minyear:maxyear)$cdat,times=minyear:maxyear),colorbar=T,xlab="Year",ylab="",power=T)
