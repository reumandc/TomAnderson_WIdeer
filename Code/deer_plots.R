...
mtext(line=1,adj=1,cex=0.75,bquote(paste("3-5, ",bar(theta)==.(round(snowabun_phase3_5,3)))))
...
mtext(line=1,adj=1,cex=0.75,bquote(paste("2-2.5, ",bar(theta)==.(round(hunterphase2_2.5,3)))))
dev.off()
