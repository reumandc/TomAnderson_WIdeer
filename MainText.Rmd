...
Population cycles have intrigued ecologists for 100 years 
...
research has focused instead on explanations which involve nonlinear or delayed density dependence, 
...
Supporting Information (SI) sections \ref{SM-SI:theory}-\ref{SM-sect:mainproof}. The bulk of the paper 
...
the importance of a new mechanism of cycles, and for its
...
synchronizing local dynamics, can cause substantial cycles in the 
...
sun spots; @Sinclair1992_sunspots;@Selas2004_sunspots], or provided a useful but patial explanation for cycles, 
...
Our study differs from previous work, in part because the new mechanism does not require a highly regular environmental 
oscillator such as sun spots. Rather, it is sufficient for irregular environmental drivers 
...
Thus if climate change alters synchrony, as a growing number
...
not produced, by synchronous environmental drivers. In either case our mechanism is the
...
cyclic. Randomizations that removed synchrony but preserved the structure of local fluctuations eliminated the state-wide 
...
mechanisms-->
Large-scale climatic patterns and local winter weather conditions are known to influence synchrony 
...
populations because deeper snow limits access to winter food in ungulates, which subsequently 
...
The influence of winter weather on deer extends to larger regions beyond WI. Cycling 
over larger regions may be even stronger than what we have documented because
...
large areas [@brown2000;@simard2013]. The lack of longer-timescale ($3-7$-year) spatial wavelet 
...
whether a fluctuation of this magnitude is big enough to be of substantial concern.
...
because such influences may alter the cycling of populations, then influencing human activities. 
...
Historically, determination of causes of synchrony was identified as a
