...
overall choice for our research goals, some components of our theoretical 
mechanism can also be detected in our data using Fourier analyses. 
Our supplementary Fourier approaches are described in 
SI section \ref{SM-SI:methods}, and use standard techniques.
Fourier approaches
