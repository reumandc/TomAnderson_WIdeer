...
(see also Fig. \ref{SM-InflationFig} and Table \ref{SM-InflationTable}).
...
<!--***DAN: make sure all new sup mat figs and tables are cited from the main text, and in the right order-->
...
semi-periodic oscillatory phenomenon on statewide spatial scales. Thus, the essence of our theoretical results was borne out in our empirical results (compare Figure \ref{Fig1_example} to Figure \ref{SM-PedagogEmp_Fig}). Depending on 
...
clearly (SI section \ref{SM-SI:results}, Figs \ref{SM-FigS_SpectPow3to7Fig5Surrogs}-\ref{SM-FigS_StateVCounty},
Table \ref{SM-InflationTable}) 
that: 1) there was a meaningful spectral peak in the
...
Figs \ref{SM-FigS_DVCSpectPow3to7Fig5Surrogs}-\ref{SM-FigS_DVCSpectraFig5Surrogs}). 
...
10-year population synchrony and 10-year cycles. In scenario 1, the asynchronous-environment scenario,
...
\label{Fig3_DeerSync}}
\end{figure}
<!--***DAN: Tom, on 2020 05 12 I looked at the knitted version of the above fig and the y-axis number labels
were runnign into each other. Please fix.-->
