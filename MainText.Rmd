...
The bulk of the paper is spent examining empirical evidence for the mechanism.
...
<!--***DAN: need to review how Sup mat is organized, and how it is cited, and
whether these are consistent with Ecol Lett requirements-->
...
$\sum_{i \neq j}^N C_{\epsilon_{i}\epsilon_{j}}(f)\right]$, encapsulates
...
<!--***DAN: make this citation to the sup mat use the language Ecol Lett expects-->
...
whether a regional population cycles. See SI Appendix X
<!--***DAN: get the language right and automate the citation-->
for the the general theoretical development and 
Figs \ref{SM-TheoryExample1}, \ref{SM-TheoryExample2},
