...
by the predictors included in the model. As part of these procedures, we evaluated 
...
NAO was not 
related to deer abundance synchrony (Table \ref{Tab1_CountyCoherenceSummary}).
...
(Table \ref{SM-Tab1_CountyCoherenceSummary}, SI Figs \ref{SM-FigS5_RanksInSurrogs}B, \ref{SM-FigS6_WMFHunter}). Hunter abundance was significantly related to deer abundance on shorter timescales, around 
...
Table \ref{SM-Tab1_CountyCoherenceSummary}, SI Figs \ref{SM-FigS4_PhaseDiffs}G,
...
greater DVCs because DVCs were too infrequent to
...
certain timescales. Timescale specificity in synchrony is now know to be common 
[@Sheppard2016_aphids;@Sheppard2017_surrogates;@Walter2017_geogsync;@Sheppard_wavmodel;@Haynes_etal2019;
@Anderson2019_LO], but in our case population cycles would not have manifested in deer had deer synchrony 
