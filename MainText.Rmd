...
for the theory and for examples, including Figs \ref{SM-TheoryExample1}, \ref{SM-TheoryExample2},
...
the Fourier language of stationary stochastic processes, and our empirical analyses based on wavelets.
A suite of alternative analyses based solely on Fourier approaches is presented in SI section X,
and the results of these alternative analyses are in SI section Y.
<!--***DAN: insert references to these sections-->
All main results of the paper were obtained both through our wavelet methods and through our
alternative Fourier approaches, with the different approaches agreeing in all cases.
...
<!--***DAN: I don't think this is needed anymore but keeping it just in case:
