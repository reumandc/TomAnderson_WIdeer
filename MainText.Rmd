...
---
\newpage
<!--Need to move this to title page-->**Author Contributions:** TLA and DCR conceived the project; RER provided assistance with data curation; TLA, DCR and LWS analyzed the data; TLA and DCR wrote manuscript; LWS, RER and JAW provided extensive editing and feedback on the analysis and manuscript. 
...
refuted [@Nilssen2007_nosunspots;@Myers2013_nosunspots]. Research has since shifted to 
...
Although the decades-long research focus on density-dependent mechanisms for population
cycles has produce numerous deep insights, theoretical reasoning (Fig. \ref{Fig1_example}) suggests another mechanism
for cycles, fundamentally different from prior mechanisms and once again focused on environmental
causes, involving timescale-specific 
spatial population synchrony. Synchrony is the tendency for populations of a species in 
different locations to exhibit correlated fluctuations through time; it is a 
ubiquitous phenomenon [@Leibhold2004_sync]. If synchrony of local populations
...
in synchrony is common - synchrony often occurs on some timescales of population
dynamics and is absent on others [@Sheppard2016_aphids;@Sheppard2017_surrogates;@Walter2017_geogsync;@Sheppard_wavmodel;@Anderson2019_LO]. 
Synchrony is commonly caused by synchronized environmental 
...
that may help renew interest in environmental contributors to cycles.
