...
@Sinclair1992_sunspots;@Selas2004_sunspots] or provided a useful but only partial explanation, along with density dependence for cycles [@watson2000;@kausrud2008]. Our study differs from these 
...
Moran-like effect from ecological to human systems (deer to DVCs). <!--TOM: I think we can delete this sentence. Prior work demonstrated the
...
cyclic. Randomizations that removed synchrony but preserved the structure of the local fluctuations eliminated the state-wide 
cyclic oscillation (Fig. \ref{Fig5_StateWideFluctuations}), demonstrating synchrony likely produced the observed large-spatial-scale cycling.
...
The influence of winter weather on deer extends to larger regions beyond WI, indicating cycling of total regional deer populations and 
