...
package for the R programming language [@wsyn].
...
phasor mean field magnitudes (SI section \ref{SM-SI:methods}; SI Fig.
...
synchronizing local population dynamics, can cause substantial cycles in the 
...
produced by density dependent factors, rather than producing them outright. Our study differs from these 
