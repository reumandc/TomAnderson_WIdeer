...
abundances occurred at $3-7$ year timescales (Fig. \ref{Fig2_DeerSync}A). A related technique, the wavelet
phasor mean field (*Methods*), demonstrated the strong statistical significance of this phenomenon (Fig.
\ref{Fig2_DeerSync}B). We therefore focused our analysis on the $3-7$ year timescale band. Most past analyses of
...
was related to winter snow depth ($P =$ 0.05; Table \ref{SM-TabS1_CountyCohereneSummary}), in a near anti-phase relationship
(mean phase difference between abundance and snow depth across $3-7$-year timescales, in units of ${\pi}$
radians: $\bar{\theta} =$ 0.86; Fig. \ref{SM-FigS3_PhaseDiffs}): deer abundances tended to peak in years of
...
($P =$ 0.04; Table \ref{SM-TabS1_CountyCoherenceSummary}), both averaged over the winter months ($\text{Dec}_{t-1}$ 
to $\text{Mar}_t$; abbreviations MEIw
...
-0.60; Fig. \ref{SM-FigS3_PhaseDiffs}). At $5$-yr periodicity, these phase lags correspond to deer populations
