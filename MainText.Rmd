...
<!--***DAN: Tom, please make the numbers in the above line be autolinks-->
...
1) add back in the column for timescale band
2) put all the results for timescale bands other than 3-7 back into the table - these are in table S1 now
...
values for the deer v snow depth results, some of the deer v hunters results, and the DVC results
...
citations, please), in which case get rid of it.
  Tom, can you also remove panel C from Fig. 3, please. Keep the code, though, in case we need it.
...
the predictor is not a spatially resolved variable.
  Finally-finally, you will have to remove Fig. S11E, though you can keep S11F. You'll have to relabel 
the panels. The caption will have to be changed, but you can leave that to me if you want.
-->
