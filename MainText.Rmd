...
\textbf{Study System.} White-tailed deer is a species of considerable interest due to its major 
economic and cultural benefits and impacts on ecosystems [@Cote2004_deerimpacts;@Conover2011_bookchp]. Across 
the USA in 2011, US\$$34$Bn were spent on hunting big game, including deer [@usfws2011_survey]. 
In WI, hunting-related economic activity accounts for ~$1\%$ of state GDP [@usfws2011_survey]. DVCs cause about 
50 human fatalities and US\$$1.5$Bn in vehicular damage annually across the USA [@Conover2011_bookchp]. Thus it 
...
related technique, the wavelet phasor mean field (*Methods*, SI Appendix Fig.
...
`r round(-5*Tab1_results$MeanPhase[Tab1_results$Predictor=="Winter MEI"&Tab1_results$Timescale=="3-7"]/2,1)` years after mild winters. Applying the wavelet Moran theorem ([@Sheppard2016_aphids;@Sheppard_wavmodel], *Methods*), 
...
abundance at $3-4$-year timescales when data were aggregated to USDA districts (*Methods*, SI Appendix text and Table \ref{SM-TabS2_SummaryDistrict}). Dynamics at $3-4$-year timescales were not well explained by either $\text{MEI}_{\text{w}}$ or $\text{PDO}_{\text{w}}$, which instead contributed more
