...
Results, and then a sup mat section elaborating.-->
...
Therefore, we provide an operational description, only,
...
<!--***DAN: The perspective we used above was that we explain methods operationally and
the reader has to look elsewhere. But the referee does not like that, so you can change it
some here and in substance, i.e., add more description of the techniques in the sup mat, at
least.-->
...
<!--***DAN: The following para has to be rewritten so that it:
...
and we wanted to keep it simpler (maybe this last point best saved later? - Discussion).
...
<!--***DAN: Add a section here on the fact that we also carried out Fourier analyses.
We regard the wavelet analyses are more appropriate, or more consistent with how results
are actually discovered, or something like that, but we also present the Fourier
analyses as supporting results because some people are more comfortable with those.
Describe the Fourier results very briefly and refer to Sup Mat Methods for a full
description-->
...
Spatial wavelet coherence, wavelet linear regression, and a wavelet Moran theorem (*Methods*) demonstrated that 
...
<!--***DAN: The rest of this paragraph has to be rewritten-->
...
(*Discussion*), are not particularly
...
<!--***DAN: Make a statement here about the Fourier results, and then refer the reader to Sup Mat Results where they are
presented in full.-->
