...
state-total DVC time series as well. Fluctuations in deer population abundances in
...
Let me know if you really disagree and we can discuss.  
...
not be minimized. I think the theory is a major contribution of this version of the 
paper, even though we did not previously have it in earlier versions.--><!--**Tom:Sounds good- the journal will likely have an opinion about where its goes so let them decide-->
...
dynamics similar to an autoregressive moving average (ARMA) 
model within a habitat patch, and $F_{\text{popdyn}}(f)$
...
<!--***DAN: Tom, can we please add a reference here of SAK as a standard technique--><!--***Tom: The millspaugh reference actually says this and is already in the sentence so maybe its good-->
...
Snow depth and climate index results may have indicated distinct components
of the phenomenon whereby winter weather synchronizes deer on $3-7$-year 
timescales (SI section \ref{SM-SI:results}).
NAO was not 
...
assumptions made about costs and reporting rates of DVCs (SI section \ref{SM-SI:methods}), 
...
stuff about how it would be good to look for this in other systems.--><!--I'm find deleting, especially since we are up against the limit as it is. It was just my attempt to wrap up/summarize-->
...
# Acknowledgements
D. Lyden, J. Steinglein and the WIDNR for data; D. Storm, T. Van Deelen, J. Millspaugh, J. Fox, K. Haynes, and A. Liebhold for consultation. Funding was provided by the James S McDonnell Foundation, United States National Science Foundation grants 1442595 and 1714195, United States Department of Agriculture award 2016-67012-24694, and The Nature
Conservancy. 
