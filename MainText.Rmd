...
<!--***DAN: You probably want to add some material explaining why it makes sense
to use Fourier for the theory and wavelets for the empirical analysis? Here or elsewhere?
Maybe add a few basic statements in the main text, and then a sup mat section elaborating?
If that's the way it's done, we could also add to the same section the Fourier results
we have recently developed? Still thinking about how to integrate the new analyses and 
so on that we did in response to the referee.-->
