...
in the total population computed across the region. In contrast, asynchronous
...
Here we demonstrate, using data on white-tailed deer (*Odocoileus virginianus*) in Wisconsin, USA, how timescale-specific
