...
The causes of population cycles have been investigated for over 100 years[@Myers2018_cycles]. Early explanations, for the iconic lynx-hare as well as for other systems, indicated that cyclic environmental phenomena such as sun spots drive population cycles[@Sinclair1992_sunspots;@Selas2004_sunspots]. This hypothesis was refuted[@Nilssen2007_nosunspots;@@Myers2013_nosunspots], and research foci has shifted to explaining cycles as the result of nonlinear or delayed density dependence, often via species interactions [@Krebs2018_harereview;@Krebs2013_book;@Myers2013_nosunspots;@MartinezPadilla2014_grouse]. However, if spatial synchrony operates as hypothesized above, and is produced via the Moran effect [@Moran1953], then environmental effects may produce population cycles but through a different process than originally proposed. An important aspect of this new mechanism is specificity of environmental synchronizing effects to certain timescales, which causes local dynamics to sum across space to a substantial cyclic phenomenon on those timescales. 
