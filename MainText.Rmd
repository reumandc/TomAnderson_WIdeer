...
*For several decades research has focused instead on explanations involving nonlinear or delayed density dependence, often involving trophic or parasitic interactions.
...
**Abstract:** Population cycles are a profound enigma of the natural world, the causes of which have been investigated for over 100 years. An early hypothesized explanation of cycles, for the iconic lynx-hare as well as for other systems, posited that cyclic environmental phenomena such as sun spots drive population cycles. But that hypothesis was refuted, and for several decades research has focused instead on explanations involving nonlinear or delayed density dependence, often via trophic or parasitic interactions. Here we show that timescale-specific environmental effects, by synchronizing local population dynamics on certain timescales only, cause major population cycles over large areas in white-tailed deer and deer-vehicle collisions (DVCs). We thereby demonstrate a new mechanism of cycles that centers once again on environmental influences. The mechanism differs fundamentally from earlier hypotheses that relied on a strongly cyclic driver such as sun spots. An important aspect of the new mechanism is specificity of environmental synchronizing effects to certain timescales, which causes local dynamics to sum across space to a substantial cyclic phenomenon on those timescales. Population cycles can influence biodiversity maintenance, and can have large impacts on ecosystem functioning and services. The cycles we explain can have substantial effects on agriculture, hunting, and accident recovery industries. Research shows that synchrony of some environmental drivers may be changing, possibly as part of climate change. Such changes may alter population cycles that arise via the mechanism decribed here.
...
**Significance Statement:** Understanding the mechanisms that produce cyclical patterns in population abundances has long been a goal in ecology. Here, we demonstrate a new mechanism by which population cycles can arise in white-tailed deer, as well as the consequences of cycles for humans. Fluctuations in white-tailed deer abundances in different counties of Wisconsin, USA, were highly correlated across space (i.e. exhibited spatial synchrony) due to correlated fluctuations in winter climate. Importantly, these synchronized dynamics occurred only at specific frequencies (3-7 year periodicity). Deer synchrony in turn produced synchronized deer-vehicle collisions across Wisconsin, also occurring at 3-7 year oscillations. When aggregated across Wisconsin, fluctuations in each variable for individual counties reinforced each other, producing state-wide fluctuations occurring at the same oscillation frequency. Our results likely have great importance for hunting and insurance industries, as well as the ecologial communities in which deer exist.   

Spatial population synchrony, i.e., the tendency for populations of a species in 
different locations to exhibit correlated or otherwise related fluctuations through time, is a ubiquitous phenomenon[@Leibhold2004_sync]. In theory, if synchrony of local populations
occurs on specific timescales, it can produce cycling 
...
timescales cancel out when summed. Timescale-specific synchrony should therefore 
be important for industries such as 
hunting and agriculture that exploit multiple populations across space because 
it may cause cycling in the sum of 
the exploited populations. Likewise, synchrony of pests may increase the 
magnitude of fluctuations in regional total damage 
caused by the pests [@Allstad2015_gypsysync]. 

The causes of population cycles have been investigated for over 100 years[@Myers2018_cycles]. Early explanations, for the iconic lynx-hare as well as for other systems, indicated that cyclic environmental phenomena such as sun spots drive population cycles[@Sinclair1992_sunspots;@Selas2004_sunspots]. This hypothesis was refuted[@Nilssen2007_nosunspots;@@Myers2013_nosunspots], and research foci have shifted to explaining cycles as the result of nonlinear or delayed density dependence, often via species interactions [@Krebs2018_harereview;@Krebs2013_book;@Myers2013_nosunspots;@MartinezPadilla2014_grouse]. However, if spatial synchrony operates as hypothesized above, and is produced via synchronized environmental variation (Moran effect [@Moran1953]), then environmental effects may produce population cycles but through a different process than originally proposed. An important aspect of this new mechanism is specificity of environmental synchronizing effects to certain timescales, which causes local dynamics to sum across space to a substantial cyclic phenomenon on those timescales. 

We investigate the cycling and related timescale-specific synchrony of white-tailed deer (*Odocoileus virginianus*) and DVCs in Wisconsin (WI), USA. White-tailed deer is a species of considerable interest due to its major economic and cultural benefits and impacts on ecosystems [@Cote2004_deerimpacts;@Conover2011_bookchp]. Across the USA in 2011, US\$$34$Bn were spent on hunting big game, including deer [@usfws2011_survey]. 
