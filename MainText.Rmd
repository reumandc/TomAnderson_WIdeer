...
Applying the wavelet Moran theorem, snow depth explained $`r snowabunSyncExp3_7`\%$ of 
synchrony in deer abundance at $3-7$-year timescales, but explained $`r snowabunSyncExp3_4`\%$ of synchrony in deer
...
USDA district level results for the $3-4$-year band, Table \ref{TabS2_SummaryDistrict},
...
the panels. The caption will have to be changed, but you can leave that to me if you want.--><!--TOM:-->
-->
...
Supplementary Fourier approaches (*Methods*, SI section \ref{SM-SI:methods}) which may be more familiar to
