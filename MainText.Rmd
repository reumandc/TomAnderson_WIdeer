...
Number of words in main text: 4958  
Number of figures and tables: 5 figures, 1 table  
Number of references: 59  
<!--***DAN: I updated this on 2020 09 29--> <!--***Tom: will double check for the final submission-->

\textbf{Data accessibility.} All data are available from the Dryad digital repository: https://doi.org/10.5061/dryad.rn8pk0p85  
...
influence large ungulate population dynamics in North America [@Post1998_popgrowth;@Post2004_greenland;@Ciuti2015]. 
...
which have a longer history. Also, there may be a perceived mismatch between our theory, which uses
the Fourier language of stochastic processes, and our empirical analyses based on wavelets. In SI, after presenting 
supplementary wavelet results (SI section \ref{SM-SI:results}), we discuss why there is no real mismatch in 
approaches (beginning of SI section \ref{SM-sect:alt_methods}); but we also introduce (SI section \ref{SM-sect:alt_methods})
and apply (SI section \ref{SM-sect:alt_results}) a comprehensive suite of alternative analyses of data, based solely on Fourier
approaches. All main conclusions of our work were dually supported by both our wavelet and alternative Fourier approaches,
...
SI Fig. \ref{SM-FigS5_RanksInSurrogs}A and Table \ref{SM-TabS2_SummaryDistrict}).
...
USDA district level results for the $3-4$-year band, SI Table \ref{SM-TabS2_SummaryDistrict},
which were similar but had smaller cross terms). The timescale
bands $3-4$ and $4-7$ were chosen by examination of SI Fig. \ref{SM-FigS5_RanksInSurrogs}.
...
fluctuations in traffic volume (Table \ref{Tab1_CountyCoherenceSummary}, and SI section \ref{SM-SI:results}, Table \ref{SM-TabS2_SummaryDistrict}, and Fig. \ref{SM-FigS4_PhaseDiffs}F).
...
semi-periodic oscillatory phenomenon on statewide spatial scales. Thus, the essence of our theoretical results was borne 
out in our empirical results (SI Fig. \ref{SM-PedagogEmp_Fig}). Depending on 
...
2) deer synchrony was due to environmental Moran effects and DVC synchrony was due to the synchronizing effects of deer; and
...
Figs \ref{SM-ComprehensiveFourier_SynchronyIsTimescaleSpecific_phase}-\ref{SM-Fig:StructureDecomp_DVCs}, 
Table \ref{SM-Table_AR_AIC_Table}).
...
# Acknowledgements
D. Lyden, J. Steinglein and the WIDNR for data; D. Storm, T. Van Deelen, J. Millspaugh, J. Fox, K. Haynes, and A. Liebhold for consultation; and anonymous referees for very useful feedback and some code. Funding was provided by the James S McDonnell Foundation, United States National Science Foundation grants 1442595, 1714195, and 2023474, United States Department of Agriculture award 2016-67012-24694, and The Nature
Conservancy. 
