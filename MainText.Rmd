...
function of time and timescale (*Methods*, Fig \ref{Fig1_example}G-I and SI Appendix Fig.
\ref{SM-PedagogFigWMF} provide examples), revealed that the most prominent synchrony in
county-level deer abundances occurred at $3-7$-year timescales (Fig. \ref{Fig3_DeerSync}A). A
...
<!-- Most past analyses of synchrony have used correlation methods that conflate timescales, but recent results show this can hinder detection of -->
...
Having attributed the bulk of the synchrony in deer abundance at $3-7$-year timescales to climatic Moran effects, we also found strong coherence between deer abundance and DVCs on $3-7$-year timescales: Moran effects pass from climate to deer to DVCs in a cascading manner, and in this way are ultimately responsible for synchrony of DVCs. While perhaps intuitive, as DVCs are sometimes used as a proxy for deer population size [@Grotan2005_roedeer], this result has important consequences for humans, namely that statewide there DVCs occur in a semi-period manner, tracking fluctuations in total deer populations. Thus, as climate change continues to modify ecosytems, ensuing changes for human industries that rely on wildlife and plant poulations seem likely. Changes in winter climate have aleady been reported as having a strong implications for forestry practices in Wisconsin; other industries that exploit wildlife and plant populatoins would be equally affected, and in some cases, like white-tailed with semi-periodic regularity. 
