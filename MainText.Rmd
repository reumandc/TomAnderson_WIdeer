...
refuted, however [@Nilssen2007_nosunspots;@Myers2013_nosunspots], and whereas it is now recognized that environmental drivers can alter cycles through their interactions with intrisic population
...
band, since this is adequately demonstrated by our wavelet coherence results between deer and $\text{MEI}_{\text{w}}$,
...
<!--***DAN: Dan, you may want to add something to the discussion that coherence with MEI/PDO (together
...
Winter weather influences deer beyond WI. Cycling 
over larger regions may be even stronger than what we documented because
...
such influences may alter the cycling of populations. 
