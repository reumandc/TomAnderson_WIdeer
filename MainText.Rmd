...
synchronous phenomena by obscuring important synchrony on some timescales with asynchronous or noisy dynamics on other timescales [@Sheppard2016_aphids]; and synchrony must be specific to certain timescales to produce cyclic dynamics of
total populations on those timescales (Fig. \ref{Fig1_example}).  

<!--***DAN: maybe we dont even need the following para-->
...
our understanding of important population phenomena because it may lead to cyclic 
...
[@Allstad2015_gypsysync]. Our data show the reality of this effect and its 
...
vary by US\$$`r round(2*avgdvccostsLow,-6)`-`r round(2*avgdvccostsHigh,-6)`$ 
