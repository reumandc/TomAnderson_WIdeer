...
<!--***DAN: remaining to do
1) add the sentence explaining the summer MEI coherence with deer, including a ref from Tom
2) make sure the length stats in the front matter are correct
3) maybe mention in the cover letter that data will be deposited in Dryad when the time comes 
$) finish going through the response
-->
...
<!--***DAN: don't forget to fill this stuff in--> <!--***Tom: will double check for the final submission-->
