...
phasor mean field [@Sheppard2013;@Sheppard2016_aphids]. Both methods take as input
...
(mean field magnitude) and phase (phasor mean field) (Figs \ref{Fig1_example},
\ref{SM-PedagogFigWMF}). They also show where in the time series the synchrony
...
related technique, the wavelet phasor mean field (SI Appendix Fig.
\ref{SM-PedagogFigWMF}), demonstrated the strong statistical significance of this phenomenon (Fig.
...
abundances tended to peak in years of below-average snow. No other weather variables were statistically significant (Table \ref{Tab1_CountyCoherenceSummary}) with deer abundance. Wavelet mean field and 
...
band, thereby inducing synchrony in that band and leading to total-population cycles on the same timescales. Timescale specificity in synchrony is common [@Sheppard2016_aphids;@Sheppard2017_surrogates;@Walter2017_geogsync;@Sheppard_wavmodel]. 
...
An important aspect of all of the phenomena we described is their specificity 
to certain timescales. Although it is known that a spatially synchronous environmental driver can induce population synchrony via Moran effects [@Leibhold2004_sync; @Moran1953;  
@Ranta1997_moran], historically it has been  
difficult to attribute synchrony  
in natural populations to specific environmental drivers versus other potential  
causes of synchrony such as dispersal [@Kendall2000_moran;@Abbott2007_moran].  
The analytical methods used here facilitated more precise  
identification of Moran drivers  
[@Sheppard2016_aphids;@Sheppard2017_surrogates;@Walter2017_geogsync;@Sheppard_wavmodel, with   
their effectiveness occuring in part due to their capacity to decompose  
synchrony according to the distinct timescales on which it can occur (Fig.  
...
Deer population sychrony lagged both climate indices at a temporal scale of about two years, which is similar to other reported lag times of climatic effects on deer 
populations [@Post1998_popgrowth;@forchhammer1998]. Winter weather and climatic oscillations have been identified previously as mechanisms influencing synchrony in other ungulates across multiple 
regions [@Post2004_greenland;@Grotan2005_roedeer;@Hegel2012_caribou]. This effect probably occurred because deeper snow limits access to winter food resources in ungulates, which subsequently affects body condition, leading to greater susceptibility to starvation or predators and reduced parturition rates [@Mysterud2008_deerclimate;@Hegel2012_caribou]. <!--add in somethign here about climate change affecting deer populations-->
...
humans, namely that statewide there DVCs occur in a semi-period manner, tracking fluctuations in
...
have aleady been reported as having a strong implications for forestry practices in Wisconsin; other industries that exploit wildlife and plant populatoins would be equally affected, and in some cases, like white-tailed with semi-periodic regularity. 
...
Similarly, fluctuations of a quarter 
million deer likely have considerable consequences for agricultural crop damage 
and hunting success, both of which can have socioeconomic impacts. See 
SI Appendix for further details on the cycling mechanism.
