...
Applying the wavelet Moran theorem, snow depth explained $16\%$ of 
synchrony in deer abundance at $3-7$-year timescales, but explained $40\%$ of synchrony in deer
<!--***DAN: Tom, please make the numbers in the above line be autolinks--><!--TOM: -->
...
values for the deer v snow depth results, some of the deer v hunters results, and the DVC results--><!--TOM: made sync explained and xterms both NA-->
...
citations, please), in which case get rid of it.--><!--TOM:-->
  <!--Tom, can you also remove panel C from Fig. 3, please. Keep the code, though, in case we need it.--><!--TOM:-->
...
the predictor is not a spatially resolved variable.--><!--TOM:-->
