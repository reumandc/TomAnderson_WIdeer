...
could follow (Rohani et al. 1999). In other words, for example,
...
synchrony and/or population cycles from populations that have economic
...
collisions and their economic cost. Fluctuations in deer abundances in
...
Natural Resources (WIDNR) spanning the `r dim(cty.list$Abun)[2]`-yr period `r minyear`-`r maxyear` (Fig. \ref{Fig2_Timeseries}). 
