...
-->
Population cycles are a profound enigma of the natural world, the causes of which have been investigated for over 100 years[@Myers2018_cycles]. An early hypothesized explanation of cycles, for the iconic lynx-hare as well as for other systems, posited that cyclic environmental phenomena such as sun spots drive population cycles[@Sinclair1992_sunspots;@Selas2004_sunspots]. But that hypothesis was refuted[@Nilssen2007_nosunspots;@@Myers2013_nosunspots], and for several decades research has focused instead on explanations involving nonlinear or delayed density dependence, often via trophic or parasitic interactions[@Krebs2018_harereview;@Krebs2013_book;@Myers2013_nosunspots;@MartinezPadilla2014_grouse]. Here we show that timescale-specific environmental effects, by synchronizing local population dynamics on certain timescales only, cause major population cycles over large areas in white-tailed deer and deer-vehicle collisions (DVCs). We thereby demonstrate a new mechanism of cycles that centers once again on environmental influences. The mechanism differs fundamentally from earlier hypotheses that relied on a strongly cyclic driver such as sun spots. An important aspect of the new mechanism is specificity of environmental synchronizing effects to certain timescales, which causes local dynamics to sum across space to a substantial cyclic phenomenon on those timescales. Population cycles can influence biodiversity maintenance[@Chesson2000], and can have large impacts on ecosystem functioning and services. The cycles we explain can have substantial effects on agriculture, hunting, and accident recovery industries. Research shows that synchrony of some environmental drivers may be changing, possibly as part of climate change[@Allstad2015_gypsysync;@Sheppard2016_aphids;@Koenig2016_birdsync;@Shestakova2016_forestsync]. Such changes may alter population cycles that arise via the mechanism decribed here.
...
different locations to exhibit correlated or otherwise related fluctuations through time, is a ubiquitous phenomenon[@Leibhold2004_sync], and is at the root of the mechanism
of cycling that we describe. In theory, if synchrony of local populations
