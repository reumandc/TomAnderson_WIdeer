...
The causes of population cycles have interested and mystified ecologists for over 100 years [@Myers2018_cycles]. An early hypothesis for the cause of cycles, for the iconic lynx-hare as well as for other systems, posited that cyclic environmental phenomena such as sun spots drive population cycles [@Sinclair1992_sunspots;@Selas2004_sunspots]. However, that hypothesis lacked empirical support [@Nilssen2007_nosunspots;@Myers2013_nosunspots], and for several decades research as focused instead on explanations involving nonlinear or delayed density dependence, often via predator-prey interactions, parasitism, and disease [@Krebs2018_harereview;@Krebs2013_book;@Myers2013_nosunspots;@MartinezPadilla2014_grouse]. 

Population cycles and spatial synchrony, the tendency for geographically separate populations to exhibit correlated temporal fluctuations, are fundamentally linked. 
Theory predicts that individual cyclic populations can easily be brought into synchrony via weak coupling from dispersal or shared exogenous forcing, such as weather (Moran effects), in a process known as nonlinear phase locking [@Bjornstad2000. Empirical evidence from laboratory experiments [@VassuerFox_2009;@HopsonFox_2019] and analysis of observational data [@Haynes_etal2019] support these predictions. Indeed, the iconic example of the Canadian lynx-snowshoe hare system features predator-prey cycles thought to be synchronized across Canada by Moran effects (refs). As a consequence, the prevailing paradigm is that cycles and synchrony are linked because populations whose dynamics are intrinsically cyclic are easy to synchronize; that is, population cycles give rise to spatial synchrony.

We herein propose and provide evidence for a mechanism by which the direction of causality can be reversed and, instead, spatial synchrony can give rise to population cycles: a periodic exogenous driver synchronizes non-cyclic local populations  on a particular timescale (frequency), producing region-wide cycles at that timescale. Many environmental drivers of biological dynamics, such as climate, fluctuate on characteristic timescales. For example, from ca. 1965-1995, fluctuations in the North Atlantic Oscillation (NAO) centered on 10-year timescales, and this was shown to synchronize aphid phenology in the United Kingdom at these particular timescales, via the effect of NAO on winter temperatures [@Sheppard2016_aphids]. Growing evidence suggests that timescale-specific spatial synchrony may be common [@Sheppard2017_surrogates;@Walter2017_geogsync;@Anderson2019_LO;@Sheppard_wavmodel;@Haynes_etal2019]. <!--TLA::I think the theory section should go somewhere around here but sure where exactly-->Combining timescale-specific synchrony with the hypothesis that synchrony amplifies shared fluctuations in local time series, one sees that when a set of local populations are synchronized at a particular timescale, those synchronous fluctuations will become amplified in the regional aggregate, while non-synchronous fluctuations at other timescales will tend to cancel each other out. Therefore  cycles appear in the regional aggregate, with period length equal to the timescale of synchrony (Fig. \ref{Fig1_example}).

One major applied concern of synchrony is that it if shared
fluctuations in local time series do become amplified in a
timescale-specific manner as above, outbreaks of pests or disease
could follow [@Rohani_etal1999]. In other words, for example,
synchrony of individual populations of pests may produce cycles in the
regional total damage caused by the pests. Timescale-specific
...
the sum of the exploited populations. However, cascading effects of
synchrony and/or population cycles in species that have economic
value to human concerns are rarely considered. 

Here we demonstrate, in white-tailed deer, how timescale-specific
spatial synchrony can produce regional population cycles, and the
consequences of such cycles for humans through numbers of deer-vehicle
collisions (DVCs) and their economic cost. Fluctuations in deer abundances in
different counties in Wisconsin, USA, were highly synchronous due to
fluctuations in winter climate. Importantly, these synchronized
dynamics occurred only on 3-7 year timescales. Deer synchrony in turn
produced synchronized oscillations in deer-vehicle collisions across
Wisconsin, again with 3-7 year periodicity. When aggregated spatially,
fluctuations for individual counties reinforced each other on 3-7 year
timescales, producing state-wide cycles.
