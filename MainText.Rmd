...
timescales is removed via a randomization procedure. Therefore, it is spatial synchrony 
...
cyclic. Eliminating synchrony via randomizations also eliminated the state-wide 
...
and musk oxen [@post2002]. Here, winter snow depth,  $\text{MEI}_{\text{w}}$ and $\text{PDO}_{\text{w}}$ 
