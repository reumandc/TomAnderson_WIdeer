...
[@Sheppard2016_aphids], and the El Ni$\~{n}$no Southern Oscillation (ENSO) also has 
...
Dynamics of the total population are then dominated by a cycle on that timescale. 
...
Here we demonstrate, using data on white-tailed deer (*Odocoileus virginianus*) in 
Wisconsin, USA, how timescale-specific
...
Holder for references: See Figs \ref{SM-TheoryExample1}, \ref{SM-TheoryExample2},
