...
background on spectral statistics can be found from many sources [@Reinsel1997, @Shumway2000, and @Brillinger2001]. We here define notation. 
...
See Reinsel [-@Reinsel1997], Shumway [-@Shumway2000], and Brillinger [-@Brillinger2001]
...
all subsequent analyses (Fig. \ref{MT-Fig2_Timeseries}). he number of weather stations per county and data collected at each station 
