...
what we currently have? Even a white paper?-->
...
model results, for similar reasons.-->
...
`wsyn` package for the R programming language [@Rstats2018].
...
using the function `wpmf` in the `wsyn` package.
