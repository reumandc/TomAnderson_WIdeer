...
applied which support our wavelet results for deer. 
...
timescales/frequencies. For this analysi, we considered two multiple-testing corrections, both very conservative but one even more so than the other.
...
95th quantile of surrogate spectra. Our two Bonferroni-corrected thresholds for a family-wise error rate of $0.05$ 
...
\ref{FigS_SpectraARSurrogs}). <!--TOM: I wonder if this list of points should only go in the response to reviewers-->We emphasize that these tests are excessively conservative and sub-optimal for multiple 
