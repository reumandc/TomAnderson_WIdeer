...
as a function of timescale [@Sheppard2016_aphids; @Sheppard_wavmodel], is 
\begin{equation}
...
\textbf{Fraction of deer synchrony explained by winter MEI.} Fractions of deer abundance synchrony explained by snow depth and fractions of DVC synchrony
...
<!--Explanation of why we can't just do this naively-->
<!--Make sure to mention:
We know, because of the coherence results, that some weather variable related to winter MEI causes synchrony in deer
We just don't know for sure how much. 
We can compute it the naive way.
-->

<!--***DAN: Lawrence's text, redundant with the above so commented and marked for deletion.
As presented in results, we find that that the degree of spatial wavelet coherence found 
between winter MEI and the deer abundance fluctuations is unlikely to arise under a null 
hypothesis of no association between MEI and deer. Our test yielded p$<$0.05 of producing results as extreme as observed, for Fourier-phase-shuffled surrogate data that preserves the autocorrelation structure of the data.   This indicates that common winter climate conditions across sites, as indexed by the MEI, are a likely driver of the local variations in deer abundance and their spatial synchrony.-->
...
\textbf{Fraction of deer synchrony explained by winter MEI, county data.}
<!--***DAN: Fill in Lawrence's results here-->
