...
\textbf{Fraction of deer synchrony explained by $\text{MEI}_{\text{w}}$, technical methods.} Fractions of deer abundance synchrony explained by snow depth and fractions of DVC synchrony
...
$\text{MEI}_{\text{w}}$ index means, in summary, that the estimated coherence, $|\Pi^{(01)}_{\sigma}|$ between deer abundance and MEI
...
\textbf{Fraction of deer synchrony explained by $\text{MEI}_{\text{w}}$, county data, technical results.} Of the parameters 
...
\caption[Phase differences between variables]{Phase differences between variables as a function of timescale for the main significant relationships of main text Table \ref{MT-Tab1_CountyCoherenceSummary}, county-level data: A) $\text{MEI}_{\text{w}}$ ($\text{MEI}_{\text{w}}$) 
and deer abundance, B) $\text{MEI}_{\text{s}}$ and 
