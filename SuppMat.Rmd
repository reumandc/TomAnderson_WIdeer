...
\subsection{Fourier methods}\label{SI:methods:Fouriermethods} 
\noindent Although our wavelet methods were most appropriate for initial discovery
...
\subsection{Use of Fourier methods for the theory and wavelets for the empirical analysis}\label{SI:methods:methodsmismatch} 
\noindent Fourier and
