...
El Ni$\tilde{n}$o<!--TOM: I can't get the tilde to be produced correctly over the n. This is the closest I got but it makes it italic.-->/Southern Oscillation Index (MEI), and the Pacific 
...
time series at the county level. <!--TOM: Is this technically correct for teh climate indices, since its one value for all-->
...
<!--***DAN: Tom, you had attached a bunch of marginal comments to the version of this para in the Word doc, and I tried to act on those as best I could. Please revise the result--><!--TOM: I only made one minor change in here, otherwise I think it looks good-->
