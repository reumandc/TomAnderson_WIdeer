...
more round of that.-->
Fractions of deer abundance synchrony explained by snow depth and of DVC synchrony
explain by deer, and related results, were presented in the main text, but we did not there present results
on fractions of deer abundance synchrony explained by winter MEI. Deer abundance and winter MEI
exhibited significant spatial wavelet coherence, supporting the 
hypothesis that a winter-climatic Moran effect related to ENSO was partly responsible for deer
synchrony. But the wavelet Moran theorem and related techniques are most effective when 
data are spatially resolved. MEI is a single index, so was not spatially resolved. What follows is a 
