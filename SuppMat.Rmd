...
usda_abunsnwd_syncexp34<-TabS4_results$SynchronyExplained[TabS4_results$Predictor=="Snow Depth" & TabS4_results$Response=="Abunance" & TabS4_results$Timescale=="3-4"]
...
Figs \ref{Fig2}C, \ref{FigS6_}E, colors). 
...
attributable to synchrony (Fig. \ref{Fig4}).
...
(Fig. \ref{Fig4}) of `r avgdvcfluc`, and if we assume 
