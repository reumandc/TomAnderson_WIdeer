...
[@Sheppard2016_aphids], where additional details are also available. Panels a-d show the principle of how synchrony
...
straightforwardly significance tested as described in [@Sheppard_wavmodel].
\label{PedagogFigWMF}}
\end{figure}
...
from supplementary figure 5 of [@Sheppard2016_aphids].
...
of synchrony-preserving surrogate data sets [@Sheppard2016_aphids]
appropriately representing the
null hypothesis of no relationship between the $x$ and $y$.
Also see [@Sheppard2016_aphids] for a description of how the aggregate long- and short-timescale $P$-values were computed. \label{PedagogFigSpatCoh}}
\end{figure}
