...
possible a visual comparison, and tests of whether, for each timescale/frequency in the $3-7$-year band
the spectrum of data was above the distribution of spectra for surrogates. To calculate spectral power in
the $3-7$-year band summed a raw periodigram across those timescales; to display the spectrum
