...
is a linearization [\citealp{Desharnais2018}, their supplementary information section 1.2] 
...
\label{prop:mainprop}
\end{proposition}
The proof is in (REF to right sup mat section).
<!--***DAN: don't forget to put the right reference in-->
...
Crucially for our purposes, the first sum, $\sum_i S_{\epsilon_{i}\epsilon_{i}}$, 
is of $N$ quantities and the
second sum, $\sum_{i \neq j} C_{\epsilon_{i}\epsilon_{j}}$, is of $N^2 - N$ quantities, 
suggesting that, when $N$ is large enough, timescale specificity of
synchrony of noise across locations will tend to be more important for $S_{\text{tot}}$ than
