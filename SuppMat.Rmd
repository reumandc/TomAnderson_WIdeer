...
<!--***DAN: Tom email on 10/24 indicating code for S10 still needed to be added now that we have split from reumannplatz, so Dan is not sure if Fig S10 is accurate or what at this point. Heard from Tom on 10/24 and it isnt accurate but he is working on it.-->
...
<!--***DAN: put something about how problems with cross terms will should get less at larger spatial scales, and what that means and why, but need to think this through and also talk to lawrence about it first. Get Lawrence to draft a paragraph initially. He is writing one.-->
...
<!--***DAN: Dan stopped here in Methods, 2018/10/24, and went on for now to results below-->
...
<!--***DAN: Dan stopping here 2018 10 24, 445pm. Next time: edit the below, then go back up to do the rest of methods, then pull and knit again and check the new version of Fig S8-->
