...
quarter-cycle phase shifts (Table \ref{TabS2_SummaryDistrict}). <!--Tom: I think we have to take out this sentence since it uses wavelet multiple regression to get the synchrony explainedCombined, snow depth, $\text{MEI}_{\text{w}}$, and $\text{PDO}_{\text{w}}$ explained $`r round(usda.abunmodelSyncExp,0)`\%$ of the 
