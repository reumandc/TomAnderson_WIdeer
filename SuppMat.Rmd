...
knitr::kable(TableS2,
             col.names=c("Predictor","Response","P-value","Mean phase ($\\bar{\\theta}$)"),
             format='pandoc',
...
<!--TOM: The new code runs these as wavelet coherences- I checked these and it gives identifcal values using either one time series or multiple time series for phase and p-value (after using set.seed).-->
