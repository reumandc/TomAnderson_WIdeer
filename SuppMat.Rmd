...
We now provide technical background on the wavelet mean field, taken from 
@Sheppard2016_aphids and reproduced here for reader convenience. Letting 
...
We provide technical background on the spatial wavelet coherence, taken from
@Sheppard2016_aphids and @Sheppard_wavmodel (but also available elsewhere, e.g, @Prichard1994) and reproduced 
...
<!--Then explain the technical side of everything in this section.-->
We now provide technical background on the wavelet Moran theorem and related ideas, taken from
@Sheppard2016_aphids and @Sheppard_wavmodel and reproduced here for reader convenience.
...
\emph{\textbf{The wavelet Moran theorem.}}
...
\begin{equation}
q(\sigma)=\frac{|\Pi^{(01)}_{\sigma}|^2\frac{1}{T}\sum_{t=1}^{T} |r^{(\text{\emph{wmf}},1)}_{\sigma}(t)|^2}{\frac{1}{T}\sum_{t=1}^{T}|r^{(\text{\emph{wmf}},0)}_{\sigma}(t)|^2}.
\end{equation}
\noindent This was averaged over a timescale band of interest.  

\textbf{Fraction of deer synchrony explained by winter MEI.}
...
more round of that.-->
Fractions of deer abundance synchrony explained by snow depth and fractions of DVC synchrony
...
-->
Fitted AR(2) model to winter MEI time series data we had (Dan to check and say what fitting methods, what data, etc)
Used resulting parameters to generate 1 time series of length  
