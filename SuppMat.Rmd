...
El Nino/Southern Oscillation Index (MEI), and the Pacific 
...
Also, and importantly, when you rerun with 100000 (if indeed we do - not clear to me it's strictly necessary) we will have to re-check that all statements are consistent with the new results, because all the results will change. They should not change much, but they will change. Will have to review for this.--><!--TOM: Yeah, making it dynamic makes sense, jsut something I hadn't updated yet since I hadn't edited the text in a while. I had dropped down the surrogate number just to decrease run time when I was working out all the kinks of knitting- I raised it back up. -->
...
(Fig. \ref{FigS8_WMFAndPredictionsDistricts}A,C). Deer abundance was significantly related to $\text{MEI}_{\text{w}}$ and $\text{MEI}_{\text{s}}$, 
...
<!--***DAN: Tom, please review this caption carefully, as I have edited it heavily. I looked through the code to tryto make sure I was not introducing any errors in descriptions of what was done, but please be sure yourself, too, to be on the safe side. I emailed you about this and I have also taken your response into account, but another check from you would be useful.--><!--TOM:Found one typo but looks good to me-->
...
<!--***DAN: Tom, in the first two columns you get labels like "WinterNAO" instead of "Winter NAO" (with a space). Can you please fix that? Not just for Winter NAO but for all entries in the first two columns. Like wise please fix the same problem as it occurs in Tables S3 and S5.--><!--TOM:Fixed-->
...
<!--***DAN: Tom, please review this caption carefully, as I have edited it heavily. I looked through the code to tryto make sure I was not introducing any errors in descriptions of what was done, but please be sure yourself, too, to be on the safe side. I emailed you about this and I have also taken your response into account, but another check from you would be useful.--><!--Tom: fixed a typo but otherwise looks good-->
