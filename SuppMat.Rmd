...
\textbf{Wavelet Moran theorem, fractions of synchrony explained, and the "predicted synchrony" plot.} We calculated 
...
\textbf{Wavelet Moran theorem, fractions of synchrony explained, and the "predicted synchrony" plot", technical background.}
