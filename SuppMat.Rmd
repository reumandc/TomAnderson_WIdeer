...
#             booktabs=T)
```
$^1$For $3-5$-year timescales, $p = 0.028$<!--***DAN: -->, phase $= 0.871$<!--***DAN: -->, and synchrony explained $= 0.288$.<!--***DAN: -->
...
#knitr::kable(,#Insert name of R dataframe containing table S2 here
#             format='pandoc',
...
#knitr::kable(,#Insert name of R dataframe containing table S3 here
#             format='pandoc',
