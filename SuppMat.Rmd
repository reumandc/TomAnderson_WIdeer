...
\end{equation}
which also follows straightforwardly from the definitions of the spectra and cospectra of the population processes $w_i$ 
and the spectrum, $S_{\text{tot}}$, of $w_{\text{tot}}=\sum_i w_i$. We computed estimates of $\sum_i C_{w_i w_i}$ and 
...
<!--***DAN: got to here in this section-->
