...
(`r minyear`-`r maxyear`; Fig. \ref{FigS1_Timeseries}). 
...
(Fig. \ref{FigS1_Timeseries}), which constituted an index of the estimated 
...
the number of police-investigated DVCs, representing an 
...
There were roughly $6$ to $8$ counties per district (Fig. \ref{FigS2_map}). 
...
Fig. \ref{FigS6_WMFAndPredictionsDistricts}, suggesting the results for counties are not 
...
the timescale considered (Fig. \ref{Fig1_example}). 
...
Fig. \ref{FigS7_WMFsAndWPMFsAncillary}. 
...
influence deer abundance (Fig. 1\ref{FigS1_Timeseries}), 
and the 
