...
explained by winter MEI is just $|\Pi^{(01)}_{\sigma}|^2$. This is the quantity we statistically tested using surrogates to 
...
Moran theorem suggests that winter MEI explains $`r round(abunwmeiSyncExp37,2)`\%$ of deer abundance synchrony 
on $3-7$-year timescales and $`r round(abunwmeiSyncExp47,0)`\%$ on $4-7$-year timescales. 
...
\begin{figure}[!h]
\includegraphics[height=.55\textheight]{Results/PedagogEmpFig.png}
...
in detail in the main text, snow depth and winter MEI (B) produced a combined Moran effect on deer (E), which caused 
...
on DVCs (F), which casued synchrony in DVCs (I) on $3-7$-year timescales, thereby resulting in a DVC cycle on statewide
