...
deviations were always less than $6\%$. Thus parameters were available for which our model gave reasonable
...
estimate, based solely on the wavelet Moran theorem, that winter MEI explained $X\%$
<!--***DAN: Tom, please insert autolinked value here-->
of deer abundance synchrony was probably an overestimate by approximately $25\%$; an adjusted value was $Y\%$.
<!--***DAN: Tim, please insert autolink - should be the X from above divided by 1.2528-->
This adjusted quantity is still substantial. 
