---
title: Supplementary Materials for "Synchronous Effects Produce Major Cycles in Deer Populations
...
> Figs S1 to S8  
> Table S1 to S5  
> Full Reference list[@Leibhold2004_sync; @Allstad2015_gypsysync; @Moran1953; @Ranta1997_moran; @Kendall2000_moran; @Abbott2007_moran;@Sheppard2016_aphids;@Sheppard2017_surrogates; @Walter2017_geogsync; @Cote2004_deerimpacts; @Conover2011_bookchp; @usfws2011_survey; @Sheppard_wavmodel;  @Mysterud2008_deerclimate; @Hegel2012_caribou; @Rodionov2003_elnino; @Post1998_popgrowth; @Post2004_greenland; @Grotan2005_roedeer; @Huijser2008_dvc; @Marcoux2010_dvc; @Koenig2016_birdsync; @Shestakova2016_forestsync; @Cai2014_elnino;@widnr2001; @Ciuti2015; @Millspaugh2009; @Buonaccorsi2001; @Sheppard2013; @Theiler1992; @Schreiber2000]  
...
aggregated to larger spatial scales (Table \ref{TabS4_SummaryDistrict}, 
...
There are two alternative elaborations of the mechanisms presented in the main text by which
...
eliminated the state-wide oscillations (Fig. \ref{MT-Fig4_StateWideFluctuations}). Variation A
...
[7], where additional details are also available. Panels a-d show the principle of how synchrony
...
straightforwardly significance tested as described in [13]. \label{PedagogFigWMF}}
\end{figure}
...
from supplementary figure 5 of [7].
...
of synchrony-preserving surrogate data sets [7]
appropriately representing the
null hypothesis of no relationship between the $x$ and $y$.
Also see [7] for a description of how the aggregate long- and short-timescale $P$-values were computed. \label{PedagogFigSpatCoh}}
\end{figure}
<!--- TOM: Citations in caption above are not dynamic links, need to change manualy--->
\newpage
